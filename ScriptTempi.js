...
function allowedDistanceValue(distanceCheck) {
...
preliminaryChecks(document.getElementById("t1").value.trim(), document.getElementById("d1").value.trim());
...
preliminaryChecks(document.getElementById("tempo").value.trim(), "0");
